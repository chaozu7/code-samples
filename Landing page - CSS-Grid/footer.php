<footer class="footer">
        ...
        <div class="footer__navigation ">
            <ul class="footer__links ">
                ...
                <li class="footer__item footer__item--1 "><a href="#section__contact_us " class="footer__link ">Kontakt</a></li>
                <li class="footer__item footer__item--2 "><a href="#section__about-us " class="footer__link ">O firmie</a></li>
                <li class="footer__item footer__item--3 "><a class="footer__link " href="#section__offer">Oferta</a></li>
                <li class="footer__item footer__item--4 "><a class="footer__link " href="# ">Portfolio</a></li>
